...
const auteur = {
  ...
  job: {
    ...
    start: start,
    today: today,
    NbExpérience: today - start
  }
};

const texteHtmlPays = document.getElementById("pays");
texteHtmlPays.innerHTML = auteur.pays;
const texteHtmlVille = document.getElementById("ville");
texteHtmlVille.innerHTML = auteur.ville;
const texteHtmlAge = document.getElementById("age");
texteHtmlAge.innerHTML = auteur.age;
const texteHtmlNbExperience = document.getElementById("nbExperience");
texteHtmlNbExperience.innerHTML = auteur.job.NbExpérience;
