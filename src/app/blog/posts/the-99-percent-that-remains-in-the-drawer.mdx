...
{/* <CodeBlock className="my-24"
    ...
    codeInstances={[
        {
            code: '<Button\n    className="button"\n    suffixIcon="chevronRight">\n   Bonjour je suis un code tsx \n</Button>',
            label: "test d'un code",
            language: 'tsx'
        },
    ]}
    copyButton
...
![Once UI logo on dark background.](/images/projects/project-01/cover-01.webp)
